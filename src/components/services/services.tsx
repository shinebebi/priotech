...
const service = [
    'Разработка разделов проектной документации стадии П в соответствии с ППРФ № 87',
    'Разработка сметной документации стадии П в соответствии с Методикой № 421/пр',
