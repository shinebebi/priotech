...
const steps = [
    'Полный анализ имеющейся проектной документации с предоставлением итоговой документации',
    'Обозначение ключевых позиций, имеющих потенциал к оптимизации за счёт корректировки использованных решений',
    'Предоставление вариантов решений с их количественными и ценовыми показателями',
    'Разработка или корректировка рабочей документации по согласованному ТЗ',
